...
//
// ASIC note:
// - Package contains constants/types only.
// - No hardware is inferred directly from this package.
//------------------------------------------------------------------------
...
parameter logic [31:0] DBG_REG_SCR_ADDR = DEBUG_BASE + 32'h20;
parameter logic [31:0] DBG_REG_SCR_WDATA = DEBUG_BASE + 32'h24;
parameter logic [31:0] DBG_REG_SCR_RDATA = DEBUG_BASE + 32'h28;
parameter logic [31:0] DBG_REG_SCR_CONTROL = DEBUG_BASE + 32'h2C;
