...
// ---------------------------------------------------
// ACC_SRC_A/B/C, LEN, DST
// ---------------------------------------------------
8'h02: src_a_q <= wdata_i;
8'h03: src_b_q <= wdata_i;
8'h04: src_c_q <= wdata_i;
8'h05: len_q <= wdata_i;
8'h06: dst_q <= wdata_i;
...
assign accel_src_c_o = src_c_q;
assign accel_len_o = len_q;
assign accel_dst_o = dst_q;
...
@(posedge clk) disable iff (!rst_n)
(accel_start_o && !(accel_cmd_o inside {
ACC_CMD_VADD8,
ACC_CMD_VSUB8,
ACC_CMD_VMAX8,
ACC_CMD_RELU8,
